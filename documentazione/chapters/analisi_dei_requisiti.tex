...
\includegraphics[width=.65\textwidth]{assets/usecase/not_logged_user_usecase.pdf}\bskip
\includegraphics[width=\textwidth]{assets/usecase/logged_user_usecase.pdf}
...
\begin{itemize}
	\item Una barra di ricerca in alto per cercare le aste in base alla loro descrizione.
	\item La lista delle categorie scorrevole orizzontalmente, cliccando su una di queste, verranno mostrate solo le aste di quella categoria.
...
Infine premerà il tasto "Salva" per salvare le modifiche effettuate.
