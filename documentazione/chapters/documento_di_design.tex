...
\\ Il sistema verifica che l'asta sia attiva, e invia una richiesta al server per la creazione dell'offerta, restituendo l'esito all'utente, mediante l'interfaccia grafica.  
\\
