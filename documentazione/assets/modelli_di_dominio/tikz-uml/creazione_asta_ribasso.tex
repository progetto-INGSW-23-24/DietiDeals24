\begin{center}
	\scalebox{0.68}{
		\begin{tikzpicture}
			...
			\umlclass[type=Boundary, left=3cm of CreateAuction, yshift=1cm]{CreateEnglishAuction}{
			}{}
			
			\umlclass[type=Boundary, left=3cm of CreateAuction, yshift=-2cm]{CreateSilentAuction}{
			}{}

			\umlclass[type=Boundary, right=3cm of CreateAuction]{NavBar}{
